  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card text-white p-5 bg-gradient" style="background-image: url('fond-transparent-rose.png');">
            <div class="card-body border border-primary">
              ...
              <form action="https://formspree.io/YOUREMAILHERE">
                <div class="form-group" id="groupConnection">
                  ...
                  <input type="email" class="form-control" placeholder="Enter email" id="inputMail" name="mailConnection" required="required"> </div>
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" class="form-control" placeholder="Password" id="inputPassword" name="passwordConnection" required="required"> </div>
